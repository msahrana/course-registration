...
const Cart = ({selectCourse, remaining, totalCost}) => {
    ...
    return (
        <div className='h-auto bg-white text-left mx-8 rounded-lg'>
            <h3 className='mx-8 text-2xl font-semibold text-green-600 border-b-2'>Credit Hour Remaining: {remaining} </h3>
            ...
            <h5 className='mx-8 font-semibold mt-4 mb-4 border-b-2 border-t-2'>Total Credit Hour: {totalCost} </h5>
